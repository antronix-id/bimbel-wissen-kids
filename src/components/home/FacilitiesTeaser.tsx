    ...
    <section className="py-16 sm:py-24 bg-slate-900 text-white relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
          ...
          <Link
            href="/galeri"
            className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-slate-800 hover:bg-slate-700 text-white font-bold text-xs border border-slate-700 transition-colors shrink-0"
          >
          ...
          {previewItems.map((item) => (
            ...
            >
              <div className="relative h-56 sm:h-64 w-full overflow-hidden">
                ...
                <span className="absolute top-4 left-4 text-[11px] font-bold px-3 py-1 rounded-full bg-blue-600/90 text-white backdrop-blur-sm shadow-xs">
                  {item.category}
                </span>
              </div>
              ...
              <div className="p-5 flex-1 flex flex-col justify-between">
                <div>
                  <h3 className="font-bold text-base text-white mb-1.5 group-hover:text-blue-300 transition-colors">
                    {item.title}
                  </h3>
